...
const generateMessageIDV2 = (userId) => {
    ...
    return 'RyzenTheGreat-' + hash.toString('hex').toUpperCase().substring(0, 18);
};
exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => 'RyzenTheGreat-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
